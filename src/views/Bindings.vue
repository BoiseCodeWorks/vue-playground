  ...
  <div class="bindings container">
    <div class="row">
      <div class="col-12">
        <h1>Bindings</h1>
        <p>
          So we have learned that using the double curlies {{ val }} allows us
          to run javascript code(expressions) directly from our html.
        </p>
        <p>
          We also have access to our components data object and can get its
          ...
          components data object with the double curlies {{ val }}.
        </p>
        <p>For example:</p>
        ...
        <p>
          We can also perform two way data binding(from our html input, to our
          javascript, back to another location in our html). To tie our input in
          our html to our javascript in our components data we will use the
          v-model. We will then use the double curlies {{ val }} to render that
          new value in our html.
        </p>
        <p>For example:</p>
        ...
        <p>
          Results when isActive = false:
          <span class="red">This text will turn green on active</span>
        </p>
        <p>
          Results when isActive = true:
          <span class="green">This text will turn green on active</span>
        </p>
        <p>
...
export default {
  ...
  setup() {
    const state = reactive({
      ...
      note2:
        '<!--The object determines wether or not to add the class "active" to the elements class list-->',
      val: "{{ }}",
      val2: "{{ myName }}",
      val3: "{{ message }}",
      message: "Hello World!",

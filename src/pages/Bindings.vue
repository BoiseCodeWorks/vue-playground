    ...
    <div class="row">
      <div class="col-12">
        ...
        <p>
          ...
          components data object with the double curlies {{ state.val }}.
        </p>
        <p>For example:</p>
    ...
    setup() {
      const state = reactive({
        ...
        <p>
          ...
          v-model. We will then use the double curlies {{ state.val }} to render
          that new value in our html.
        </p>
        <p>For example:</p>
  ...
  setup() {
    ...
    return {
      state
        ...
        <p>For example:</p>
        <h5>Class Binding</h5>
        <pre><code class="language-html">{{state.note2}}
